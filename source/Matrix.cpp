...
namespace dae {
	...
	{
		//todo W2
		Matrix TranslationMatrix = { Vector4(x,0,0,0), Vector4(0,y,0,0), Vector4(0,0,z,0), Vector4(0,0,0,1) };
	...
	Matrix Matrix::CreateRotationX(float pitch)
	{
		...
		Matrix RotationMatrixX = { 
			Vector4(1,0,0,0),
			Vector4(0, cosPitch, sinPitch,0), 
			Vector4(0, -sinPitch, cosPitch,0), 
	...
	Matrix Matrix::CreateRotationY(float yaw)
	{
		...
		Matrix RotationMatrixY = { 
			Vector4(cosYaw,0.f, -sinYaw, 0),
			Vector4(0,1,0,0),
			Vector4( sinYaw, 0.f,cosYaw, 0),
			Vector4(0.f,0.f,0.f,1.f)
		};
	...
	Matrix Matrix::CreateRotationZ(float roll)
	{
		...
		Matrix RotationMatrixZ = {
			Vector4(cosRoll, sinRoll, 0.f, 0.f),
			Vector4(-sinRoll, cosRoll, 0.f, 0.f),
			Vector4(0,0,1,0),
			Vector4(0.f,0.f,0.f,1.f)
		};
	...
	Matrix Matrix::CreateRotation(const Vector3& r)
	{
		...
		return { RotationMatrix * CreateRotationX(r.x) * CreateRotationY(r.y) * CreateRotationZ(r.z) };
	}
